...
def main():
    ...
    if uploaded_image1 is not None and uploaded_image2 is not None:
        ...
        if st.button('Predict'):
            ...
            st.write("Normalized Difference Vegetation Index :", ndvi)
            st.write("Triangular Vegetation Index :", tvi)
            st.write(" Soil-Adjusted Vegetation Index :", savi)
            st.write("Renormalized Difference Vegetation Index :", rdvi)
            st.write("Modified Simple Ratio :", msr)
